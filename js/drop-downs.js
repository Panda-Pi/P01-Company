...
$(document).ready( function() {
	...
	*/
	$("a.dd-toggle").click( function(e) { 
		...
		*/
		if ( $(this).next("ul").hasClass("list-show") ) {
			...
			*/
			$(this).next("ul").removeClass("list-show").addClass("hide");
		} 
		// Else means that this is the case if our drop-down is not shown
		else {

			// As a result, we do the reverse of what is listed above.
			$(this).next("ul").removeClass("hide").addClass("list-show");
		}
	});

	// $("a.dd-toggle").hover( function(e) { 
