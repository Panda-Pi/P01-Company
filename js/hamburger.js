...
$(document).ready( function() {
	...
	*/
	$("#navToggle").click( function() { 
		...
		$("#menu-item-women-ham").text("WOMEN");
		$("#menu-item-men-ham").text("MEN");
		$(".navBar-icon").css("display", "block");
		$(".navBar-icon").css("width", "100%");
	});

	$("#menu-item-women-ham").click( function(){
		$(".list").slideToggle(500);
	});

	$("#menu-item-men-ham").click( function(){
		$(".list").slideToggle(500);
	});
